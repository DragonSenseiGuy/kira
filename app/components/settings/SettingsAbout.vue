<template>
  <div>
    ...
    <div class="stx-card">
      ...
      <div class="stx-item" style="border-bottom: none">
        ...
        <div style="display: flex; gap: 8px">
          <a
            class="stx-btn"
            href="https://github.com/Mostlime12195/Libre-Assistant"
            target="_blank"
    ...
    <div class="stx-card">
      <div class="stx-card-title">What is Libre Assistant?</div>
      <p class="about-paragraph">
        Libre Assistant is an open-source AI chat interface with a simple promise: your data stays
        on your device. Conversations, memory and settings live in your browser's local storage —
        nothing is sold, profiled or stored server-side.
      </p>
      <p class="about-paragraph">
