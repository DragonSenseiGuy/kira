<template>
  <div>
    <div class="stx-header">
      <h2>Providers</h2>
      <p>
        Libre Assistant is built for <a href="https://ai.hackclub.com" target="_blank">Hack Club AI</a>, but you can add any number of
          ...
          <div style="min-width: 0">
            <div class="stx-provider-name">
              ...
              <span
                ...
                title="Routes local models to Libre Assistant">
                Local
              </span>
            </div>
