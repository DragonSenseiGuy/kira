<template>
  <div>
    <div class="stx-header">
      <h2>Search &amp; Tools</h2>
      <p>
        Libre's web search is powered by Exa. You can choose to use Hack Club's Exa router (provided you've attached your Hack Club AI API key), attach or your own Exa key, or disable search entirely.
      </p>
    </div>
