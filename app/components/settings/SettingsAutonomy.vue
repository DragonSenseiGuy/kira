<template>
  <div>
    <div class="stx-header">
      <h2>Autonomy</h2>
      <p>
        Control what the code sandbox may do on its own. Libre Assistant can use Exa's search tools without limits, but it can also directly fetch from URLs with stricter limits.
      </p>
    </div>
